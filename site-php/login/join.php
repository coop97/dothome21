                        ...
                        <fieldset>
                            ...
                            <div class="member-box">
                                ...
                                <div>
                                    ...
                                    <input type="password" name="youPassC" id="youPassC" class="input_write" maxlength="20" placeholder="다시 한 번 비밀번호를 적어주세요!" autocmplete="off">
                                </div>
                                <div>
                                    <label for="youName">이름</label>
                                    <input type="text" name="youName" id="youName" class="input_write" maxlength="5" placeholder="이름을 적어주세요!" autocmplete="off">
                                </div>
                                <div>
                                    <label for="youBirth">생년월일</label>
                                    <input type="text" name="youBirth" id="youBirth" class="input_write" placeholder="YYYY-MM-DD" autocmplete="off">
                                </div>
                                <div>
                                    <label for="youPhone">핸드폰 번호</label>
                                    <input type="text" name="youPhone" id="youPhone" class="input_write" placeholder="000-0000-0000" autocmplete="off">
                                </div>
                            </div>
                        </fieldset>
